        ...
        RowLayout {
            ...
            Column {
                ...
                PlasmaComponents.Label {
                    ...
                    width: parent.width
                    opacity: 0.9
                    height: plasmoid.configuration.displayArtist ? parent.height / 2 : parent.height
                ...
                PlasmaComponents.Label {
                    ...
                    width: parent.width
                    opacity: 0.7
                    height: plasmoid.configuration.displayArtist ? parent.height / 2 : 0
                    visible: plasmoid.configuration.displayArtist
